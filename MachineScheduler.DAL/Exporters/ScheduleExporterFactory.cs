...
namespace MachineScheduler.DAL.Exporters
{
    ...
    {
        public IScheduleExporterStrategy Create(List<MachineSchedule> schedules, FileInfo fileInfo, ExportMode exportMode = default) =>
            IsSupportedFiletype(fileInfo.Extension) ?
            fileInfo.Extension switch
            {
                ".xlsx" => new ScheduleExporterExcel(schedules, fileInfo, exportMode),
