...
using KrasNonFerMet.Core.Model;
using OfficeOpenXml;

namespace KrasNonFerMet.Core.Extensions
{
    public static class ExcelWorksheetsExtensions
    {
        public static List<T> ToList<T>(this ExcelWorksheet worksheet/*, out IList duplicates*/) where T : class, IEntity, new()
        {
